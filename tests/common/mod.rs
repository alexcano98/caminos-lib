...
/// Encapsulates the parameters needed to create a Cartesian shift meta_pattern (x, y) -> (x + shift_x, y + shift_y)
...
/// Creates a Configuration Value with the parameters for the Cartesian shift meta_pattern
...
/// Encapsulates the parameters needed to create a Cartesian meta_pattern
...
/// Creates a Configuration Value with the parameters for the Cartesian meta_pattern
...
/// Creates a Configuration Value with the parameters for the Homogeneous traffic meta_pattern
pub fn create_homogeneous_traffic(arg: HomogeneousTrafficBuilder) -> ConfigurationValue
{
    ConfigurationValue::Object("HomogeneousTraffic".to_string(), vec![
        ("meta_pattern".to_string(), arg.pattern),
...
/// Encapsulates the parameters needed to create a Burst traffic meta_pattern.
...
/// Creates a Configuration Value with the parameters for the Burst traffic meta_pattern
pub fn create_burst_traffic(arg: BurstTrafficBuilder) -> ConfigurationValue
{
    ConfigurationValue::Object("Burst".to_string(), vec![("meta_pattern".to_string(), arg.pattern ),
                                                         ("servers".to_string(), ConfigurationValue::Number(arg.servers as f64)),
...
{
    ConfigurationValue::Object("PeriodicBurst".to_string(), vec![("meta_pattern".to_string(), arg.pattern ),
